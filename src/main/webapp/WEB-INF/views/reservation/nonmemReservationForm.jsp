...
<body>	
				...
				<div class="sub">
					...
					<nav class="sub_navi">
						<ul>
							...
							<li><a href="moveNres.do" title="비회원예약">비회원예약</a></li>
						</ul>
					</nav>
                  </div>
			</div>
	...
	<div id="wrap">
	<form action="insertNres.do" method="post" name="res_form" class="res_form" onsubmit="return validate();">			
			<div class="box">
				<p>진료 담당의 </p>
				<div class="input">
			...
			<div class="box">
				<p>이름 </p>
				<div class="input">
					<input type="text" name="res_name" id="res_name" class="input1" maxlength="10" placeholder="이름" value="" required>
				</div>
			</div>
			...
			<div class="box">
				<p>생년월일</p>
				<div class="input">
					<input type="text" name="res_birth" id="res_birth" class="input1" maxlength="8" placeholder="8자리 숫자만 입력해주세요. ex)19910415" value="" required>
				</div>
			</div>
			...
			<div class="box">
				<p>연락처 </p>
				<div class="input">
					<input type="text" name="res_phone" id="res_phone" class="input1" maxlength="15" placeholder="공백이나 기호 없이 숫자만 입력해주세요." value="" onkeydown="onlyNumber(this)" required>
				</div>
			</div>
			...
			<div class="box">
				<p>이메일 </p>
				<div class="input">
					<input type="text" name="res_email" id="res_email" class="input1" value="" required>
				</div>
			</div>
			...
			<div class="box pw">
				<p>비밀번호 </p>
				<div class="input">
					<input type="password" name="res_passwd" class="input1" maxlength="20" placeholder="예약확인 시 필요합니다." required>
				</div>	
			</div>	
