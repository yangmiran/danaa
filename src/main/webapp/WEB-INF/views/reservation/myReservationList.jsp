...
<body>
	...
	<input type="hidden" name="res_phone" value="${ reservation.res_phone }">
	<input type="hidden" name="res_passwd" value="${ reservation.res_passwd }">	
	<input type="submit" class="resboard_btn btn_common" value="예약 취소" style="cursor:pointer;" onclick="javascritp:this.form.action='resCancel.do';">
