				...
				<div class="reviewbox">
					...
					<div class="reviewinput">
						<input type="text" name="review_title" id="title"
							class="reviewinput1" placeholder="제목" value="">
					</div>
					...
					<div class="reviewbox">
						...
						<div class="reviewinput">
							<input type="text" name="review_writer" readonly value="${ sessionScope.loginMember.id }"  id="name" class="input1" maxlength="10" placeholder="이름" value=""> 
						</div>
					</div>
					...
					<div class="reviewbox">
						...
						<div class="reviewinput">
							<!-- <input type="text" name="review_content" id="content"
								class="reviewinput2" placeholder="내용을 입력해주세요" value="">  -->
						...
						<div class="reviewbox">
							...
							<input type="file" name="ofile" class="reviewinput1">
						</div>
	</section>
	<!-- //write_form -->
