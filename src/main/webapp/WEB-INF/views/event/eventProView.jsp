	...
	<section id="container" class="jmboard">
		...
		<div class="jmboard_box">
         ...
         [맨처음]&nbsp;
				...
				<c:if test="${ currentPage > 1 }">
					<c:url var="ubl" value="proEvent.do">
				...
				<c:if
					...
					<c:url var="ubl2" value="proEvent.do">
         ...
         [이전그룹]&nbsp;
				...
				<c:forEach var="p" begin="${ startPage }" end="${ endPage }"
					...
					<c:if test="${ p ne currentPage }">
						<c:url var="ubl3" value="proEvent.do">
				...
				<c:if
					...
					<c:url var="ubl4" value="proEvent.do">
         ...
         [맨끝]&nbsp;
				...
				<c:if test="${ currentPage < maxPage }">
					<c:url var="ubl5" value="proEvent.do">
			...
			<!-- 관리자계정 글쓰기 활성화 -->
			<div class="list_util" align="center">
